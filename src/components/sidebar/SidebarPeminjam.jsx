...
function SidebarPeminjam({ sidebarOpen, setSidebarOpen }) {
    ...
    <div>
      ...
      >
        ...
        <div className="space-y-28">
          {/* Pages group */}
          <div>
            <h2 className="text-xs uppercase text-slate-500 font-semibold pl-3 py-10">
                        ...
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/peminjam/dashboard/dataBuku"
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                              }
                            >
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/peminjam/dashboard/borrowed"
                              className={({ isActive }) =>
                                'block transition duration-150 truncate ' + (isActive ? 'text-indigo-500' : 'text-slate-400 hover:text-slate-200')
                              }
                            >
