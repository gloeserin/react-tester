...
export default function DataPetugas() {
  ...
  //   try {
  //     const response = await axios.get('http://localhost:5000/petugas').then((res) => {
  //       setPetugas(res.data);
  //       return res.data
  //     }
  //     );
  ...
  //   try {
  //     await axios.delete(`http://localhost:5000/petugas/${id}`);
  //     getPetugas();
  //   } catch (error) {
  //     console.log(error);
  //   } 
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark shadow-lg">
        ...
        <div className="grid grid-cols-5 border-t border-stroke py-5 px-4 dark:border-strokedark  md:px-6 2xl:px-7.5">
          ...
          <div className="col-span-1 hidden items-center sm:flex">
            <p className="font-medium">Nama Petugas</p>
          </div>
          <div className="col-span-1 flex items-center">
          ...
          <div className="col-span-1 flex items-center">
            ...
            >
              ...
              <td className="border-b col-span-1 border-[#eee] py-5  dark:border-strokedark">
                <div className="flex items-center space-x-3.5">
                  <button className="hover:text-primary">
                  <Link to={`/admin/dashboard/editPetugas`}>
                    <FaRegEdit />
                  </Link>
                  </button>
                  <button className="hover:text-primary" 
